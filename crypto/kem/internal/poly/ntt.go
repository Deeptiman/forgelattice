...
import (
	...
	"github.com/Deeptiman/forgelattice/crypto/kem/internal/mathutils"
...
// Each block is reduced modulo x² ± zeta where dsa and root are determined by the NTT structure.
//
